...
export default function About() {
  ...
  return (
    <>
      <Helmet>
        <title>About | Uday Rana</title>
        <meta
          name="description"
          content="Learn more about Uday Rana – a passionate web developer with expertise in React, JavaScript, UI/UX, backend development and modern design systems."
        />
        <link
          rel="canonical"
          href="https://uday-rana-portfolio.vercel.app/about"
        />

        <meta property="og:title" content="About | Uday Rana" />
